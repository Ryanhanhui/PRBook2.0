...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        ...
        gr: {
            ...
            clear: '清空',
            drag: '拖放',
            sizeError: '$1 超过最大文件大小',// $1=file name ,$2=max file size ie( example.jpg has has exceed the size limit of 2mb)
            extError: '$1 文件类型不受支持',// $1=file extension ie(exe files are not supported)
            someErrorsOccurred: '发生错误啦'
        }
    };
